                ...
                Thread thread = new Thread(new Runnable(){
                    ...
                    public void run() {
                        try {
                            ...
                            HttpPost httppost = new HttpPost("http://211.221.128.124:3000/new");
                            Log.d("lalalalala", "http://211.221.128.124:3000/new");
                            try {
                                // create a list to store HTTP variables and their values
                                Log.d("lalalalala", "add");
                                List nameValuePairs = new ArrayList();
                                // add an HTTP variable and value pair
                                nameValuePairs.add(new BasicNameValuePair("time", "오후"));
                                nameValuePairs.add(new BasicNameValuePair("message", mUserToDoItem.getToDoText()));
